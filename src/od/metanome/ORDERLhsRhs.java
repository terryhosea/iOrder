...
import od.metanome.check.DependencyChecker;
import od.metanome.sorting.partitions.SortedPartition;
import od.metanome.types.ByteArray;
...
public class ORDERLhsRhs extends ORDER {
    ...
    public void execute() throws AlgorithmExecutionException {
        ...
        if(MainClass.FirstTimeRun) {
            ...
            System.out.println("");
            System.out.println("# FD : " + FDList.size());
            System.out.println("# OrderComp : " + OrderCompList.size());
            System.out.println("");
        }
